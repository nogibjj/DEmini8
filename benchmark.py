...
def print_results(python_results, rust_results):
    ...
    print("-" * 50)
    print(
        f"{'SHA-256 Time (s)':<20} {python_results[0]:<15.6f} {rust_results[0]:<15.6f}"
    )
    print(
        f"{'SHA-256 Memory (MB)':<20} {python_results[1]:<15.2f} {rust_results[1]:<15.2f}"
    )
    print(f"{'MD5 Time (s)':<20} {python_results[2]:<15.6f} {rust_results[2]:<15.6f}")
    print(
        f"{'MD5 Memory (MB)':<20} {python_results[3]:<15.2f} {rust_results[3]:<15.2f}"
    )
